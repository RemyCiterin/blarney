...
See [Abstracting the Classic Five-Stage Pipeline](https://www.repository.cam.ac.uk/handle/1810/385421), a tutorial paper that introduces Blarney and applies it to the development of a simple processor pipeline.
